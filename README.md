...
```typescript
const sobreMim = {
  nome: "Enzo Santos Yamaguchi",
  cargo: "Student",
  localizacao: "Brasil 🇧🇷",
  stack: ["Python"],
  aprendendoAgora: ["Cybersecurity."],
  curiosidade: "Gosto de estudar cybersegurança e programação quando estou com tédio.",
  procurando: "Estágio",
}
```

- Atualmente trabalhando em **[FoxHole](https://github.com/enzoyamaguchi/FoxHole)**
...
<img src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExbmN3ZzI1eGcxYmx2ZWZoMGprZmgwZmoydmVxajMxYzA0emFzMDR0dyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/sNUWF7fAUP2q4/giphy.gif" alt="Rodapé" />
